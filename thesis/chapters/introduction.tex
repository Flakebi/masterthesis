...
A pixel shader is a programs which determines the color of each rasterized pixel and it is executed by general purpose processing units on the GPU.
...
Uniform variables permits optimizations that are impossible for divergent variables.
