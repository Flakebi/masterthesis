...
Throughout this paper, we will use the term \emph{SIMD lane} for a single work-item.
For a group of work-items which are run on the same SIMD unit, we will use the expression \emph{SIMD unit}.
