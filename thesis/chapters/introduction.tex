...
Throughout this paper, we will use the term \emph{SIMD lane} for a single work-item. As a wavefront (AMD) or warp (NVIDIA) is run on a SIMD unit, we will use the expression \emph{SIMD unit}.
