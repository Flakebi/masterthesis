...
This section introductes the hard- and software of graphics processors. Further we explain concepts that are used in the implementation, like the ELF format.
