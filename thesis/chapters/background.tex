...
When executing a shader, GPUs wait a lot of time for memory. To deliver a good performance, they employ multiple techniques to hide memory latency and keep the arithmetic cores busy.
